...
export const BRIEF_MODES: BriefMode[] = [
  ...
  },
  {
    ...
    fallback:
      'Hello from my desk in East Lansing. I’m Sai. I build AI systems, backend services, and product workflows. Right now I’m at Zymo Solutions, building backend services and voice agents for restaurant operations and connected commercial kitchens. My work touches APIs, databases, cloud infrastructure, device data, and agent tooling that helps get things done without digging through a bunch of screens. Before that, I built Voysly, a Voice AI interviewing platform that ran thousands of interviews across 16 client locations. I owned the system end to end, from the realtime voice flow and transcript processing to scoring, dashboards, email automation, backend APIs, deployment, and production debugging. If that resonates, or you just want to say hi, my inbox is open. Drop me a message.',
  },
  {
    id: 'caveman',
    label: 'Caveman',
